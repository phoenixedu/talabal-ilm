...
from .views import ClassOfStudentsListView,ClassOfStudentsViewForm,UPdateClassOfStudents,ClassOfStudentsDetailView,createElecture,addStudentList,eLactureDatile,eLactureAttendence,listOfElectures
urlpatterns = [
    ...
    path('<str:cls>/<int:pk>/',UPdateClassOfStudents.as_view(),name='classCupDate'),
